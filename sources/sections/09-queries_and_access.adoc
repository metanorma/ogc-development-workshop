...
include::../req/core/Req06.adoc[]

include::../req/core/Req07.adoc[]

Operations on a data cube can be trim or slice operations or other analytics.
Users from most Earth Science communities are interested in performing both
request types efficiently and fast [<<Wagemann_2017>>].
